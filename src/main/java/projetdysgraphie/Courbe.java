...
public class Courbe extends JPanel {
    ...
    /**
     * ajoute une nouvelle courbe à afficher en plus de la première (en
     * changeant sa couleur) TODO: implémenter
     *
     * @param t
     */
    ...
    public void paint(Graphics g) {
        ...
        g2d.fillRect(this.left, this.top, this.largeur, this.hauteur);
        ...
        if (this.listePoints.size() == 1) {
            ...
            for (int i = 0; i < this.listePoints.size() - 1; i++) {
                ...
                RenderingHints.KEY_ANTIALIASING,
                RenderingHints.VALUE_ANTIALIAS_ON);
                g2d.drawLine(x1 - 4, y1, x1 + 4, y1);
                 g2d.setRenderingHint(
                RenderingHints.KEY_ANTIALIASING,
                RenderingHints.VALUE_ANTIALIAS_ON);
                g2d.drawLine(x1, y1 - 4, x1, y1 + 4);
            }
    ...
    /**
     * Convertit un Point pour l'afficher sur le même reférentiel que les
     * autres.
     *
     * @param p
     * @return
    ...
    /**
     * Convertit un PointAffichage pour l'afficher sur le même reférentiel que
     * les autres.
     *
     * @param p
     * @return
